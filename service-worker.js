const CACHE_NAME = "stundenplan-f13-v8";
const SHELL_FILES = ["./", "./index.html", "./styles.css?v=3.1.0", "./data.js?v=3.1.0", "./app.js?v=3.1.0", "./manifest.json", "./brand-mark.svg", "./icon-192.png", "./icon-512.png"];
